...
class InviteRegisterFormListener implements IParameterizedEventListener {
	...
	protected function save() {
		...
		if ($this->inviteByName === true) {
			...
			// update invite data
			$usernames = [];
			if (!empty($this->invite->usernames)) $usernames = explode(', ', $this->invite->usernames);
	...
	protected function saved() {
		if ($this->invite || $this->inviteByName) {
			...
			UserNotificationHandler::getInstance()->fireEvent(
					...
					new InviteSuccessUserNotificationObject(new InviteSuccess($successID)), [$inviterID]);
